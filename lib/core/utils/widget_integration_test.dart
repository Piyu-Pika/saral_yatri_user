...
class WidgetIntegrationTest {
  ...
  static void testTicketWidgets() {
    try {
      ...
      Log.i('   Resolved Destination: ${enhancedDisplay.destinationStationName}');
      ...
      Log.i('   Full Route Description: ${enhancedDisplay.fullRouteDescription}');
      ...
      Log.i('   ✅ TicketCardWidget: Can accept both TicketModel and EnhancedTicketDisplayModel');
      
      // Test TicketListItemWidget compatibility
      Log.i('   ✅ TicketListItemWidget: Can accept both TicketModel and EnhancedTicketDisplayModel');
      
      // Test EnhancedTicketListItemWidget
      Log.i('   ✅ EnhancedTicketListItemWidget: Uses EnhancedTicketDisplayModel directly');
      
      // Test fallback behavior
      final fallbackDisplay = EnhancedTicketDisplayModel.fromTicket(sampleTicket);
      Log.i('🔄 Testing fallback behavior:');
      Log.i('   Fallback Boarding: ${fallbackDisplay.boardingStationName}');
      Log.i('   Fallback Destination: ${fallbackDisplay.destinationStationName}');
  ...
  static TicketModel _createSampleTicket() {
    ...
    return TicketModel(
      ...
      busNumber: '68ea0d6cbbb53ea5402bd1b4', // Will be resolved to actual bus number
      routeId: '68ea0d6cbbb53ea5402bd1b0',
      routeName: '68ea0d6cbbb53ea5402bd1b0', // Will be resolved to actual route name
      boardingStop: '68ea0d6cbbb53ea5402bd1a8', // Will be resolved to station name
      droppingStop: '68ea0d6cbbb53ea5402bd1aa', // Will be resolved to station name
      originalFare: 50.0,
      subsidyAmount: 5.0,
      finalFare: 45.0,
      paymentMethod: 'upi',
  ...
  static void testWidgetDisplayScenarios() {
    try {
      ...
      final scenario2 = EnhancedTicketDisplayModel.withResolvedNames(
        ticket: ticket,
        boardingStationName: 'Mumbai Central Station',
        destinationStationName: 'Station ${ticket.destinationStationId}', // Fallback
        busNumber: 'MH12AB1234',
