  ...
  static Future<void> testBookingAPI() async {
    try {
      ...
      final testBookingData = {
        ...
        'boarding_station_id': '671b8b8b8b8b8b8b8b8b8b8d', // Replace with actual station ID
        'destination_station_id': '671b8b8b8b8b8b8b8b8b8b8e', // Replace with actual station ID
        'ticket_type': 'single',
        'travel_date': DateTime.now().add(const Duration(hours: 2)).toIso8601String(),
        'payment_mode': 'upi',
      };
  ...
  static Future<void> testGetTickets() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        AppLogger.error('❌ Get Tickets API test FAILED - Unexpected status code');
      }
  ...
  static Future<void> testCalculateFare() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        AppLogger.error('❌ Calculate Fare API test FAILED - Unexpected status code');
      }
